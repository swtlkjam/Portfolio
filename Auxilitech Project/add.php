...
<body>
    <div class="container" style="width: 450px; padding-top: 25px; padding-bottom: 15px; margin-top: 50px; margin-bottom: 50px;">
        <form class="form-group" id="createAccount" action="php/add-check.php" method="post">
            <h4 class="form__title">Add User/Admin</h4>
            ...
            <button class="btn btn-dark btn-block mb-2" type="submit" name="insert">Insert</button>
